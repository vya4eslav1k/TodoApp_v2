...
import ru.todo.spring.javadaddy.todoApp.controller.openApiConfig.AuthControllerOpenApiConfig;
...
@RestController
@RequestMapping("/auth")
public class AuthController implements AuthControllerOpenApiConfig {
